...
HD_PWD='C:/Users/kluck/Downloads/sdup_projekt/GeneratorArbitralny/ip_repo/edit_awg_axi_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log awg_axi_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source awg_axi_v1_0.tcl
