...
HD_PWD='C:/Users/palka/Documents/SDUP/sdup_projekt/sdup_projekt/gen_arb_z_ip/gen_arb_z_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_awg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_awg_wrapper.tcl -notrace
