...
#
# Generated by export_simulation on Tue Jun 02 13:11:59 +0200 2026
#
################################################################################
...
'-reset_run' switch to the './design_awg.sh' script.

./design_awg.sh -reset_run
...
./design_awg.sh -noclean_files

For more information on the script, please type './design_awg.sh -help'.
